...
//     }
  environment {
      IMAGE_REPO = "hungdaocong/rsvpapp-clone-helm-cicd"
  ...
  stages {
    ...
    stage('Deploy') {
      environment {
        ...
        HELM_GIT_REPO_URL = "https://github.com/hungdaocong/rsvpapp-clone-helm-cicd.git"
        GIT_REPO_EMAIL = 'hungdc256@gmail.com'
